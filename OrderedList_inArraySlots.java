...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        list_iAS = new ArrayList<Integer>();
         for(int i = 0; i < unordered.size(); i ++) {
           System.out.println(
                "champ at index " + champIndex(unordered, i) + " with value " + list_iAS.add(unordered.get(champIndex(unordered, i)))
    ...
    /**
      ...
      @return ??
     */
     private int champIndex(ArrayList<Integer> unordered, int index) {
       int smallestIndex = index;
       int smallestInteger = unordered.get(index);
       int oldNumber = unordered.get(index);
       for (int i = index + 1; i < unordered.size(); i++){
         if (unordered.get(i) < unordered.get(smallestIndex))
            smallestIndex = i;
            smallestInteger = unordered.get(i);
       }
       unordered.set(index, unordered.get(smallestIndex));
       unordered.set(smallestIndex, oldNumber);
        return smallestIndex;  // replace this line
     }
